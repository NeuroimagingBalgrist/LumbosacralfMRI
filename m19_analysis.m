...
SC_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr.nii', directory);
SC_head = spm_vol(SC_path); SC_image = spm_read_vols(SC_head);

LD_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_region_LD_L3-S3.nii', directory);
RD_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_region_RD_L3-S3.nii', directory);
LV_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_region_LV_L3-S3.nii', directory);
RV_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_region_RV_L3-S3.nii', directory);
LVsMV_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_region_LV-MV_L3-S3.nii', directory);
RVsMV_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_region_RV-MV_L3-S3.nii', directory);
MV_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_region_MV_L3-S3.nii', directory);
...
nL3_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_neuro_L3.nii', directory);
nL4_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_neuro_L4.nii', directory);
nL5_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_neuro_L5.nii', directory);
nS1_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_neuro_S1.nii', directory);
nS2_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_neuro_S2.nii', directory);
nS3_path = sprintf('%s/grplvl_mask/crop/PAM50_cord_cr_neuro_S3.nii', directory);
...
%     Calculate percent activated per area from L3-S2 (S3 is empty).
    for k = 1:length(areaoi_name)
%          disp(nlevel_name{k})
            areaoi_total(k, i) = sum(areaoi_image.(areaoi_name{k})(:,:,34:148),"all");
            areaoi_activated95(k, i) = sum(result_image.(result_name{i})(:,:,34:148).*areaoi_image.(areaoi_name{k})(:,:,34:148)>0.95,"all");
            areaoi_percent95(k, i) = areaoi_activated95(k, i)/areaoi_total(k, i);
            areaoi_activated99(k, i) = sum(result_image.(result_name{i})(:,:,34:148).*areaoi_image.(areaoi_name{k})(:,:,34:148)>0.99,"all");
            areaoi_percent99(k, i) = areaoi_activated99(k, i)/areaoi_total(k, i);
            areaoi_activated999(k, i) = sum(result_image.(result_name{i})(:,:,34:148).*areaoi_image.(areaoi_name{k})(:,:,34:148)>0.999,"all");
...
saveas(gcf,'/*/figures/00_tscore_neuro.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable([array2table(SEQ) array2table(nlevel_tscorefull(1:5,:)','VariableNames', xticklabels)],'/*/figures/00_tscore_neuro.csv')
...
x_width=20;y_width=15;
set(gcf, 'PaperPosition', [0 0 x_width y_width]);
saveas(gcf,'/*/figures/00_tscore_region.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable([array2table(SEQ) array2table([areaoi_tscorefull(6,:); areaoi_tscorefull(2,:); areaoi_tscorefull(5,:); areaoi_tscorefull(1,:); areaoi_tscorefull(7,:)]', ...
    'VariableNames', xticklabels)],'/*/figures/00_tscore_region.csv')
...
x_width=20;y_width=15;
set(gcf, 'PaperPosition', [0 0 x_width y_width]);
saveas(gcf,'/*/figures/99_percent_neuro.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable([array2table(SEQ) array2table(nlevel_percent99(1:5,:)','VariableNames', xticklabels)],'/*/figures/99_percent_neuro.csv')
...
x_width=20;y_width=15;
set(gcf, 'PaperPosition', [0 0 x_width y_width]);
saveas(gcf,'/*/figures/99_percent_region.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable([array2table(SEQ) array2table([areaoi_percent99(6,:); areaoi_percent99(2,:); areaoi_percent99(5,:); areaoi_percent99(1,:); areaoi_percent99(7,:)]', ...
    'VariableNames', xticklabels)],'/*/figures/99_percent_region.csv')
...
x_width=20;y_width=15;
set(gcf, 'PaperPosition', [0 0 x_width y_width]);
saveas(gcf,'/*/figures/95_percent_neuro.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable([array2table(SEQ) array2table(nlevel_percent95(1:5,:)','VariableNames', xticklabels)],'/*/figures/95_percent_neuro.csv')
...
x_width=20;y_width=15;
set(gcf, 'PaperPosition', [0 0 x_width y_width]);
saveas(gcf,'/*/figures/95_percent_region.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable([array2table(SEQ) array2table([areaoi_percent95(6,:); areaoi_percent95(2,:); areaoi_percent95(5,:); areaoi_percent95(1,:); areaoi_percent95(7,:)]', ...
    'VariableNames', xticklabels)],'/*/figures/95_percent_region.csv')
...
x_width=20;y_width=15;
set(gcf, 'PaperPosition', [0 0 x_width y_width]);
saveas(gcf,'/*/figures/999_percent_neuro.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable([array2table(SEQ) array2table(nlevel_percent999(1:5,:)','VariableNames', xticklabels)],'/*/figures/999_percent_neuro.csv')
...
x_width=20;y_width=15;
set(gcf, 'PaperPosition', [0 0 x_width y_width]);
saveas(gcf,'/*/figures/999_percent_region.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable([array2table(SEQ) array2table([areaoi_percent999(6,:); areaoi_percent999(2,:); areaoi_percent999(5,:); areaoi_percent999(1,:); areaoi_percent999(7,:)]', ...
    'VariableNames', xticklabels)],'/*/figures/999_percent_region.csv')


%% Calculate Histo tScore and Percent

tscore_histo  = zeros(182, 4);
for i = 1:length(result_name)
%     disp(result_name{i})
    for slice = 1:182
...
slice = 34:1:148; %L3-S2 only

percent99_hist = figure;

plot(movmean(percent99_histo(34:148,1),10), slice, 'Color', "#0072BD", 'LineWidth',3.0)
hold on

plot(movmean(percent99_histo(34:148,2),10), slice, 'Color', "#EDB120", 'LineWidth',3.0)
hold on

plot(movmean(percent99_histo(34:148,3),10), slice, 'Color', "#77AC30", 'LineWidth',3.0)
hold on

plot(movmean(percent99_histo(34:148,4),10), slice, 'Color', "#A2142F", 'LineWidth',3.0)
axis([0 0.5 33 149])
...
set(gcf, 'PaperPosition', [0 0 x_width y_width]); %
saveas(gcf,'/*/figures/99_percent_hist.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable(array2table(movmean(percent99_histo(34:148,:),10),'VariableNames', SEQ),'/*/figures/99_percent_hist.csv')

percent95_hist = figure;

plot(movmean(percent95_histo(34:148,1),10), slice, 'Color', "#0072BD", 'LineWidth',3.0)
hold on

plot(movmean(percent95_histo(34:148,2),10), slice, 'Color', "#EDB120", 'LineWidth',3.0)
hold on

plot(movmean(percent95_histo(34:148,3),10), slice, 'Color', "#77AC30", 'LineWidth',3.0)
hold on

plot(movmean(percent95_histo(34:148,4),10), slice, 'Color', "#A2142F", 'LineWidth',3.0)
axis([0 0.6 33 149])
...
x_width=15;y_width=40;
set(gcf, 'PaperPosition', [0 0 x_width y_width]); %
saveas(gcf,'/*/figures/95_percent_hist.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable(array2table(movmean(percent95_histo(34:148,:),10),'VariableNames', SEQ),'/*/figures/95_percent_hist.csv')

percent999_hist = figure;

plot(movmean(percent999_histo(34:148,1),10), slice, 'Color', "#0072BD", 'LineWidth',3.0)
hold on

plot(movmean(percent999_histo(34:148,2),10), slice, 'Color', "#EDB120", 'LineWidth',3.0)
hold on

plot(movmean(percent999_histo(34:148,3),10), slice, 'Color', "#77AC30", 'LineWidth',3.0)
hold on

plot(movmean(percent999_histo(34:148,4),10), slice, 'Color', "#A2142F", 'LineWidth',3.0)
axis([0 0.5 33 149])
...
x_width=15;y_width=40;
set(gcf, 'PaperPosition', [0 0 x_width y_width]); %
saveas(gcf,'/*/figures/999_percent_hist.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable(array2table(movmean(percent999_histo(34:148,:),10),'VariableNames', SEQ),'/*/figures/999_percent_hist.csv')


%% Figure 99_hist_perc_RV.png

percent99_RV_histo  = zeros(182, 4);
for i = 1:length(result_name)
%     disp(result_name{i})
    for slice = 1:182
...
slice = 34:1:148; %L3-S3 only

percent99_RV_hist = figure;

plot(movmean(percent99_RV_histo(34:148,1),10), slice, 'Color', "#0072BD", 'LineWidth',3.0)
hold on

plot(movmean(percent99_RV_histo(34:148,2),10), slice, 'Color', "#EDB120", 'LineWidth',3.0)
hold on

plot(movmean(percent99_RV_histo(34:148,3),10), slice, 'Color', "#77AC30", 'LineWidth',3.0)
hold on

plot(movmean(percent99_RV_histo(34:148,4),10), slice, 'Color', "#A2142F", 'LineWidth',3.0)
axis([0 1 33 149])
...
x_width=15;y_width=40;
set(gcf, 'PaperPosition', [0 0 x_width y_width]); %
saveas(gcf,'/*/figures/99_percent_hist_RV.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable(array2table(movmean(percent99_RV_histo(34:148,:),10),'VariableNames', SEQ),'/*/figures/99_percent_hist_RV.csv')

percent95_RV_histo  = zeros(182, 4);
for i = 1:length(result_name)
%     disp(result_name{i})
    for slice = 1:182
...
plot(movmean(percent95_RV_histo(34:148,1),10), slice, 'Color', "#0072BD", 'LineWidth',3.0)
hold on

plot(movmean(percent95_RV_histo(34:148,2),10), slice, 'Color', "#EDB120", 'LineWidth',3.0)
hold on

plot(movmean(percent95_RV_histo(34:148,3),10), slice, 'Color', "#77AC30", 'LineWidth',3.0)
hold on

plot(movmean(percent95_RV_histo(34:148,4),10), slice, 'Color', "#A2142F", 'LineWidth',3.0)
axis([0 1 33 149])
...
x_width=15;y_width=40;
set(gcf, 'PaperPosition', [0 0 x_width y_width]); %
saveas(gcf,'/*/figures/95_percent_hist_RV.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable(array2table(movmean(percent95_RV_histo(34:148,:),10),'VariableNames', SEQ),'/*/figures/95_percent_hist_RV.csv')

percent999_RV_histo  = zeros(182, 4);
for i = 1:length(result_name)
%     disp(result_name{i})
    for slice = 1:182
...
plot(movmean(percent999_RV_histo(34:148,1),10), slice, 'Color', "#0072BD", 'LineWidth',3.0)
hold on

plot(movmean(percent999_RV_histo(34:148,2),10), slice, 'Color', "#EDB120", 'LineWidth',3.0)
hold on

plot(movmean(percent999_RV_histo(34:148,3),10), slice, 'Color', "#77AC30", 'LineWidth',3.0)
hold on

plot(movmean(percent999_RV_histo(34:148,4),10), slice, 'Color', "#A2142F", 'LineWidth',3.0)
axis([0 1 33 149])
...
x_width=15;y_width=40;
set(gcf, 'PaperPosition', [0 0 x_width y_width]); %
saveas(gcf,'/*/figures/999_percent_hist_RV.png')
% Save data as .csv
SEQ = ["OVS20";"iFOV28";"iFOV35";"iFOV42"];
writetable(array2table(movmean(percent999_RV_histo(34:148,:),10),'VariableNames', SEQ),'/*/figures/999_percent_hist_RV.csv')
...
% set(gcf, 'PaperPosition', [0 0 x_width y_width]); %
% saveas(gcf,'/*/figures/percent99_LV_hist.png')
...
% x_width=35;y_width=40;
% set(gcf, 'PaperPosition', [0 0 x_width y_width]); %
% saveas(gcf,'/*/figures/percent99_RD_hist.png')
...
% x_width=35;y_width=40;
% set(gcf, 'PaperPosition', [0 0 x_width y_width]); %
% saveas(gcf,'/*/figures/percent99_LD_hist.png')
...
% x_width=35;y_width=40;
% set(gcf, 'PaperPosition', [0 0 x_width y_width]); %
% saveas(gcf,'/*/figures/percent99_MV_hist.png')
